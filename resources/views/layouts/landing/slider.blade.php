<section id="slider" class="slider-element slider-parallax swiper_wrapper clearfix">
    <div class="swiper-container swiper-parent">
        <div class="swiper-wrapper">
            <div class="swiper-slide dark" style="background-image: url('{{ asset('/landing/images/slider/swiper/1.jpg') }}');">
            ...
            <div class="swiper-slide dark">
                ...
                <div class="video-wrap">
                    <video poster="{{ asset('/landing/images/videos/explore.jpg') }}" preload="auto" loop autoplay muted>
                        <source src='{{ asset('/landing/images/videos/explore.mp4') }}' type='video/mp4' />
                        <source src='{{ asset('/landing/images/videos/explore.webm') }}' type='video/webm' />
                    </video>
                    <div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
                </div>
            </div>
            <div class="swiper-slide" style="background-image: url({{ asset('/landing/images/slider/swiper/3.jpg') }}); background-position: center top;">
                <div class="container clearfix">

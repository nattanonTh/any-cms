...
@section('content')
    <section class="content">
        <form method="POST" action="{{ route('promotion.create') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="" placeholder="Title" required>
                                @error('title')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

                        ...
                        <div class="card-body" style="display: block;">
                            <div class="form-group">
                                <label for="email">Video</label>
                                    ...
                                    <textarea name="link"  class="form-control @error('link') is-invalid @enderror" cols="30" rows="10"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="" placeholder="name">
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
